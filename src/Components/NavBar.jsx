    ...
    >
      <div className='flex flex-col h-screen w-full justify-between py-3 '>
        <div className=' flex flex-col justify-center items-start pl-2 gap-y-4 '>
          <Link to='/' className=' flex flex-row items-center cursor-default w-full hover:bg-slate-400 transition-colors duration-200'>
          ...
          <Link className=' flex flex-row items-center cursor-default w-full hover:bg-slate-400 transition-colors duration-200'>
        ...
        <div className='flex flex-coljustify-center items-start pl-2 gap-y-4 '>
          <div className=' w-full rounded-l-lg hover:bg-opacity-20 transition-all duration-300 hover:bg-black flex relative flex-row items-center'>
            <ImExit className=' min-h-10 min-w-10 ' />
